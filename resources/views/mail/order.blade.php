                                    ...
                                    <td>
                                                ...
                                                <td align="left">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" width="50%">{{ $order->user->name }}</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center" style="@if($order->status == 4)  color: red @else color: #4F8A10 @endif">{{ $status[$order->status] }}</td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3" align="right"><h4><b>{{ $order->total }} đ</b></h4></td>
                                            </tr>
                                            </tbody>
                                        </table>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <span class="apple-link">1 Đại Cồ Việt, quận Hai Bà Trưng Tp Hà Nội</span><br>
                                <span class="apple-link">0123456789</span>
