...
@section("content")
    ...
    <div class="beta-map">
        ...
        <div class="abs-fullwidth beta-map wow flipInX">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.696199620684!2d105.84315191440699!3d21.004811693972474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac76ccab6dd7%3A0x55e92a5b07a97d03!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBCw6FjaCBraG9hIEjDoCBO4buZaQ!5e0!3m2!1svi!2s!4v1576834089101!5m2!1svi!2s" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
            </iframe></div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <form action="#" method="get" class="contact-form">
                        ...
                        <div class="form-block">
                            <button type="button" class="beta-btn primary">Gửi <i class="fa fa-chevron-right"></i></button>
                        </div>
                    </form>
                </div>
                <div class="col-sm-5">
                    ...
                    <p>
                        Chúng tôi luôn trông đợi những phản hồi<br> của bạn để có thể phục vụ bạn được tốt hơn <br>
